...
class CreateExamPage extends StatefulWidget {
  ...
  const CreateExamPage({super.key, required this.courseId});
...
class _CreateExamPageState extends State<CreateExamPage> {
  ...
  Future<void> _createExam() async {
    ...
    final success = await _visionAPIService.createExam(
      widget.courseId,
    ...
    if (success != null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Sınav oluşturulurken bir hata oluştu')),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Sınav Oluştur', style: TextStyle(color: Colors.white)),
